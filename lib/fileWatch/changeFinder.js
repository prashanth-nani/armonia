...
var db = new sqlite3.Database(_path2.default.join("..", "..", "armonia.db"));
...
var addToDB = exports.addToDB = function addToDB(added) {
    ...
    if (metadata.picture[0]) {
        (function () {
            ...
            _fs2.default.stat(filePath, function (err, stat) {
                if (err != null) {
                    if (err.code == 'ENOENT') {
                        _fs2.default.writeFile(_path2.default.join("..", "..", "resources", "album_arts", album_art_name), metadata.picture[0].data, function (err) {
...
var refreshDB = exports.refreshDB = function refreshDB() {
    myDb.createTables(db);
    var paths = ["/media/prashanth/body/Music/1 Nenokkadine (2014)"];
