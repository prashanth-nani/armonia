...
var ui = require(_path2.default.join(__dirname, "..", "..", "ui_renderer/js/home_renderer"));
    ...
    if (metadata.picture[0]) {
        (function () {
            ...
            _fs2.default.stat(filePath, function (err, stat) {
                if (err != null) {
                    if (err.code == 'ENOENT') {
                        _fs2.default.writeFile(_path2.default.join("..", "..", "resources", "album_arts", album_art_name), metadata.picture[0].data, function (error) {
